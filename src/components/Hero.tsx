    ...
    <section className='md:py-16 py-10'>
      ...
      >
        <div className='max-w-screen-md mx-auto'>
          ...
          >
            <Button className='bg-indigo-500 text-white hover:bg-indigo-500'>
              Start Free Trial
            </Button>
        ...
        <div className='isolate max-w-screen-xl mt-12 mx-auto relative'>
          ...
          {/* Blurry Effect */}
          <motion.div
            className='bg-indigo-500 -z-10 absolute blur-[50px] inset-5'
            initial={{
              scale: 0.4,
              opacity: 0,
            }}
          ...
          ></motion.div>
          <motion.div
            className='bg-indigo-500 rounded-full -z-10 absolute blur-[200px] inset-0 scale-x-75 scale-y-75'
            initial={{
              scale: 0.4,
              opacity: 0,
            }}
